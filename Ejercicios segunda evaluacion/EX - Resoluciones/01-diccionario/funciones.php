<?php
	...
	function conectar() { 
		...
		$conexion=@mysqli_connect('localhost','root','endswithyou','diccionario') // Si quitamos la arroba muestra warning si lo hubiera (habria que confirmar deshabilitando opciones en php.ini)
